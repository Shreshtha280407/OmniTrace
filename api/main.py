...
from api.routes import assets, evaluation, events, query, sources
...
# Not under /api/v1: the client builds asset URLs from a Source's
# storage_path, which is a storage location rather than an API resource.
